...
cd $HOME/Custom-Termux
cp login.sh $PREFIX/etc
chmod +x login.sh delete.sh setup.sh sound_effect.py banner.sh update.sh
mkdir -p $HOME/Custom-Termux/Song 
mv Access-Granted.mp3 Jarvis2.mp3 JARVIS.mp3 sound_effect.py $HOME/Custom-Termux/Song
rm 1
mkdir -p $HOME/Custom-Termux/NETWORK
mv network.py $HOME/Custom-Termux/NETWORK
